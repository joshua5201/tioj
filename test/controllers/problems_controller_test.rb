...
class ProblemsControllerTest < ActionController::TestCase
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post :create, problem: { description: @problem.description, name: @problem.name, source: @problem.source }
    end
  ...
  test "should update problem" do
    patch :update, id: @problem, problem: { description: @problem.description, name: @problem.name, source: @problem.source }
    assert_redirected_to problem_path(assigns(:problem))
  end
